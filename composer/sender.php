<?php
	 echo" <a href='direct?direct=$channel#last' class='channel_link'>
		...
		echo" 
		<a href='profile?user=$reciever' class='profile'>
		...
		echo"<td style='width:80%'>
			...
			$reciever";
			 if($total_unseen_messages != 0)
				 echo"
			<div class=circle style='width:17px; height:17px;font-size:10px;float:left;
			background-color:maroon;color:white'>
			$total_unseen_messages</div></b> ";
			
			echo"	 
			<h6 style='float:right'> 
			$time_last_message </h6>
			<tr><td><h5>
			
			$last_message<img src='$action_path' width=15px></h5> ";
		

		echo"</table> </table> </a><hr style='margin:0'>
		";
